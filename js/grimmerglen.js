...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #grimmerglen-profile-portal span{position:relative;display:grid;place-items:center;width:46px;height:46px;border-radius:48% 52% 55% 45%;background:linear-gradient(145deg,#fff 0%,#ffd9ee 54%,#d9c9ff 100%);color:#a24c9e;font:900 2rem/1 ui-rounded,'Avenir Next Rounded','Trebuchet MS',sans-serif;letter-spacing:-.08em;text-shadow:0 2px 0 #fff,0 0 9px rgba(255,255,255,.9);box-shadow:inset 3px 3px 0 rgba(255,255,255,.7),inset -3px -4px 0 rgba(184,164,255,.22),0 0 9px rgba(255,255,255,.8);}
      #grimmerglen-profile-portal span::after{content:'✦';position:absolute;top:-4px;right:1px;color:#fff;font-size:.72rem;line-height:1;text-shadow:0 0 8px #fff,0 0 12px #ffd166;}
