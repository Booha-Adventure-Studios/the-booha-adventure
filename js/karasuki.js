...
(() => {
 ...
 /* ═══════════════════════════════════════════
  ...
  ═══════════════════════════════════════════ */
  const WANDERER_DEFS = [
    { index:0,  roomId:'room_01', x:642,  y:496, type:'stay',  frames:['ichi-1.png','ichi-2.png'],                               color:'#ff79d7', size:52,  name:'Ichi',              nameJP:'イチ',              desc:'The first of three, as mean as can be, Ichi was planted beneath Karasuki. His words are sharp, his tone is rough, he pushes hard and calls your bluff. He picks and prods at all he sees, and never lets a moment ease. He may be cruel in all he\'ll say—but he is right in every way.',                                                                                                    descJP:'三人のうちの最初、イチはカラスキーの木の下に植えられた。言葉は鋭く、容赦なく、相手のごまかしを見逃さない。誰にでもきつく当たり、休まるスキを与えない。意地悪に聞こえても、その言葉はいつも正しい。' },
    { index:1,  roomId:'room_01', x:798,  y:418, type:'stay',  frames:['mr_happy-1.png','mr_happy-2.png'],                       color:'#ffd166', size:110, name:'Mister Happy',      nameJP:'ミスター・ハッピー', desc:'Mister Happy lives within Karasuki, and claims to know it perfectly. He walks its paths with open cheer, and gathers lost things wandering near. He brought them in from worlds apart, and keeps them safe within his heart. And no, that shine upon his skin—was never made, it\'s always been.',                                                                             descJP:'ミスター・ハッピーはカラスキーに住んでおり、すべてを知っていると言い張る。明るい足取りでその世界を歩き、さまよっていたものたちを見つけていく。別の世界から連れてきた存在たちを、ここで大切に守っている。そして、その顔の色は化粧ではない――それが彼の本来の姿なのだ。' },
    { index:2,  roomId:'room_02', x:882,  y:263, type:'stay',  frames:['tom_katsu-1.png','tom_katsu-2.png'],                     color:'#ffaa5e', size:65,  name:'Tom Katsu',          nameJP:'トムカツ',          desc:'Tom Katsu the pig from a circus past, watched bright balloons pop too fast. Now one floats with him wherever he goes—a quiet little fix for a sadness he knows.',                                                                              descJP:'かつてサーカスにいた豚、トムカツ。風船が弾けるたびに悲しみを覚えていた。今はいつも一つの風船がそばに浮かび、その小さな悲しみを静かに和らげている。' },
    ...
    { index:17, roomId:'room_12', x:700,  y:270, type:'stay',  frames:['october_moriyama-1.png','october_moriyama-2.png'],       color:'#ff79d7', size:78,  name:'October Moriyama',  nameJP:'オクトーバー・森山', desc:'October Moriyama, never impressed, shrugs things off like she knows best. She says she\'s not scared, not even a little—but something inside keeps things unsettled.',                                                                            descJP:'オクトーバー・森山は何事にも動じない様子で、すべてを見透かしているかのように振る舞う。怖くないと言い張るが、内側では何かがざわついている。' },
    ...
    { index:20, roomId:'room_14', x:930,  y:318, type:'haunt', frames:['ena_yamakage-1.png','ena_yamakage-2.png'],               color:'#ffb3d9', size:81,  name:'Ena Yamakage',       nameJP:'山影えな',          desc:'Ena appears when the night feels thin, and if she sees you, she\'ll see within. She points and laughs at all you hide—and if it goes on… it won\'t subside.',                                                                                      descJP:'えなは不気味な夜に現れる。目が合えば、内側まで見抜かれてしまう。隠しているものを指差して笑い、その笑いは決して消えない。' },
    { index:21, roomId:'room_15', x:850, y:480, type:'haunt', frames:['tsukigase_jubei-1.png','tsukigase_jubei-2.png'],         color:'#ffcc66', size:100, name:'Jubei Tsukigase',    nameJP:'月ヶ瀬 寿兵衛',     desc:'Jubei worked and worked, he never would stop, no time for home, no time to drop. The years moved on and took it all—now something else begins to call.',                                                                                            descJP:'寿兵衛は働き続け、休むことを知らなかった。家にも戻らず、手を止めることもなかった。気づけば時はすべてを奪い去り、今は何か別のものに呼ばれている。' },
    ...
    { index:24, roomId:'room_11', x:1170, y:381, type:'stay',  frames:['whistler-1.png','whistler-2.png'],                       color:'#c8d8ff', size:58,  name:'Whistler',           nameJP:'ウィスラー',         desc:'Whistler works from day to night, and slips through shadows out of sight. It gathers all it finds and sees, and keeps them close with quiet ease. It hums a tune, a drifting call, as moonlight leans on every wall. If whistles rise within the night, something small is gone by light.',                                                          descJP:'ウィスラーは朝から夜まで働き、気づかれないように影の中を動き回る。見つけたものを少しずつ集めては、静かに自分のものにしていく。夜になると、どこからともなく口笛が聞こえてくる。もしその音を聞いたなら、小さな何かはきっとなくなっている。' },
    { index:25, roomId:'room_10', x:993,  y:421, type:'stay',  frames:['woozlebock-1.png','woozlebock-2.png'],                   color:'#b8d4c8', size:58,  name:'Woozlebock',         nameJP:'ウーズルボック',     desc:'Woozlebock walks where shadows stay, turning wrong things the gentler way. It finds what\'s lost, what\'s torn apart, and stitches warmth into the heart. It hums where quiet darkness clings, and softens sharp and broken things. If you meet one, don\'t feel alarm—your heavy thoughts will turn to calm.',                                       descJP:'ウーズルボックは影の中を歩き、ゆがんだものをやさしく変えていく。失われたものや壊れたものに、ぬくもりをそっと縫い込んでいく。静かな闇に寄り添って、とげとげしたものを丸くしていく。もし出会ったなら、不安はいらない――重たい気持ちはやさしくほどけていく。' },
    { index:26, roomId:'room_04', x:516,  y:444, type:'stay',  frames:['tanoshiika-1.png','tanoshiika-2.png'],                   color:'#ffe0a0', size:58,  name:'Tanoshiika',         nameJP:'タノシイカ',         desc:'Tanoshiika drifts where laughter grows, and follows light wherever it flows. It dances near each joyful sound, and stays where gentle smiles are found. It greets all hearts, both near and far, and loves you simply as you are. But should unease begin to wake, it slips away like morning break.',                                               descJP:'タノシイカは笑いのある場所に寄り、やさしい空気をたどっていく。楽しげな声のそばで弾むように過ごし、穏やかな笑顔の中にいる。どんな存在にも分け隔てなく寄り添い、そのままを受け入れてくれる。でも、ほんの少しでも不安がよぎると、朝のようにすっと消えてしまう。' },
    { index:27, roomId:'room_15', x:1200, y:400, type:'haunt',  frames:['mikachan-1.png','mikachan-2.png'],                       color:'#9988cc', size:58,  name:'Mikachan',           nameJP:'ミカちゃん',         desc:'Mikachan comes when you\'re alone, where something old is softly known. It waits behind what time won\'t keep, in corners where your memories sleep. A nightmare\'s fear, a deeper seam, it lingers just outside the dream. You may escape, you may outrun—but what it touched will stay undone.',                                                   descJP:'ミカちゃんは、ひとりのときにやってくる――どこか懐かしい気配の中で。時間に取り残されたものの裏側で、眠っていた記憶のそばに潜んでいる。悪夢さえも恐れる存在で、夢の外側に静かにとどまり続ける。逃げることはできても、一度触れた記憶はずっと残り続ける。' },
    { index:28, roomId:'room_01', x:1048, y:477, type:'stay',  frames:['kara-ageha-1.png','kara-ageha-2.png'],                   color:'#ffccaa', size:58,  name:'Kara Ageha',         nameJP:'カラ・アゲハ',       desc:'Kara Ageha walks from a world once known, where quiet loss had slowly grown. She gave and gave, yet kept no part, and something faded from her heart. Now in her bag, she tucks small things, the tiny joy each trinket brings. She smiles again in borrowed ways, through little finds that fill her days.',                                        descJP:'カラアゲハは、かつていた世界の名残を抱えて歩いている。与え続けるだけの日々の中で、大切な何かを失ってしまった。今は小さな持ち物の中に、ささやかな喜びを集めている。拾い集めたものに囲まれて、少しずつ笑顔を取り戻していく。' },
    { index:29, roomId:'room_02', x:665,  y:651, type:'stay',  frames:['jinguru-kan-1.png','jinguru-kan-2.png'],                 color:'#aaccff', size:58,  name:'Jinguru Kan',        nameJP:'ジングル・カン',     desc:'Jinguru Kan stays close to sound, where gentle echoes gather round. She lost what once was always near, one by one, then none to hear. A bell now rings where she may roam, a steady chime to guide her home. If she should fade or slip from sight, its lonely song will lead the light.',                                                          descJP:'ジングルカンは、音のそばで静かに過ごしている。そばにあったぬくもりは、一つずつ消えていき、気づけば何も残らなかった。今は大きな鈴を身につけ、その音が帰る道しるべになっている。もし見えなくなっても、そのさみしい音が、きっと見つけてくれる。' },
  ];
