...
(() => {
  ...
  const WANDERER_DEFS = [
    ...
    { index:22, roomId:'room_02', x:601,  y:410, type:'stay',  frames:['denoying-1.png','denoying-2.png'],                       color:'#a8edff', size:65,  name:'Denoying',           nameJP:'デノイング',       desc:'These big birds never stop asking why. Look them in the eyes and kiss the next thirty minutes goodbye. Every answer pulls you in a little more—what you thought was simple isn\'t simple anymore.',                                                 descJP:'この大きな鳥は、どうして？どうして？と聞くのをやめない。目を合わせたら、次の30分はさようなら。どんな答えも、さらに深く引き込まれて、簡単だったことも簡単じゃなくなってしまう。' },
    { index:23, roomId:'room_12', x:449,  y:569, type:'stay',  frames:['poopika-1.png','poopika-2.png'],                         color:'#ffcc66', size:55,  name:'Poopika',            nameJP:'プーピカ',        desc:'These little creatures react to everything in sight. Even nothing feels amazing when nothing feels right. Catch a mirror\'s shine and they\'re stuck in a stare—lost in their own glow, forgetting you were there.',                               descJP:'この小さな生き物は、見えるものすべてに反応する。何もないことさえ、なぜかすごいことに思えてしまう。鏡を見つけたら、もう目が離せない——自分に夢中で、周りのことは忘れてしまう。' },
  ];
