...
/* ═══════════════════════════════════════════
  ...
  ═══════════════════════════════════════════ */
  const WANDERER_DEFS = [
    { index:0,  roomId:'room_01', x:642,  y:496, type:'stay',  frames:['ichi-1.png','ichi-2.png'],                               color:'#ff79d7', size:52,  name:'Ichi',              nameJP:'イチ',              desc:'The first of three, as mean as can be, Ichi was planted beneath Karasuki. His words cut sharp and never miss, he tears apart what others dismiss. He picks and prods at all he sees, and never lets a moment ease. He may be cruel in all he\'ll say—but he is right in every way.',                                                            descJP:'三人のうちの最初、イチはカラスキーの木の下に植えられた。言葉は鋭く、見逃すことなく、隠れたものを引きずり出す。誰にでもきつく当たり、休まる時間を与えない。意地悪に聞こえても、その言葉はいつも正しい。' },
    ...
    { index:2,  roomId:'room_02', x:882,  y:263, type:'stay',  frames:['tom_katsu-1.png','tom_katsu-2.png'],                     color:'#ffaa5e', size:65,  name:'Tom Katsu',          nameJP:'トムカツ',          desc:'Tom Katsu watched the bright things pop, where joy would rise and sudden stop. A fragile world that burst too fast, a happiness that couldn\'t last. Now one small light floats by his side, a quiet place for him to hide. A drifting fix for what he knew, a softer shade of something true.',                                                   descJP:'トムカツは、弾けて消える楽しさを見続けてきた。すぐに終わってしまう幸せに、どこか寂しさを感じていた。今はひとつの風船がそばに浮かび、静かに寄り添っている。それは小さな救いであり、彼にとってのやさしい居場所になっている。' },
    ...
    { index:15, roomId:'room_10', x:1233, y:452, type:'stay',  frames:['ni-1.png','ni-2.png'],                                   color:'#e8ffaa', size:52,  name:'Ni',                 nameJP:'ニ',                desc:'The second of three, as dull as can be, Ni is the last to leave the tree. He sits beneath what falls above, and never questions, never shoves. White marks gather, day by day, but he just lets it stay that way. No rush, no thought, no need to see—he simply sits, content to be.',                                                          descJP:'三人のうちの二番目で、とても鈍い。いつも最後まで木の下に残っている。上から落ちるものも、まったく気にしない。何も考えず、ただそこに座り続けている。' },
