...
/* ═══════════════════════════════════════════
  ...
  const WANDERER_DEFS = [
    ...
    { index:6,  roomId:'room_05', x:1029, y:502, type:'stay',  frames:['san-1.png','san-2.png'],                                 color:'#ffd08a', size:52,  name:'San',                nameJP:'参',                desc:'The last of three, as wild as can, San bit Karasuki before it began. A laughing crack before the start, a restless, tearing, reckless part. He never changed, not even one day, just stayed that strange and broken way. A burst of chaos, loud and bright—still laughing through the endless night.',                                            descJP:'三人のうちの最後で、とても狂っている。始まる前にカラスキをかじり、そのままになってしまった。一度も変わることなく、その異質なままで存在している。ただ笑いながら、荒々しく動き続けている。' },
