...
(() => {
 ...
 /* ═══════════════════════════════════════════
  ...
  const WANDERER_DEFS = [
    ...
    { index:27, roomId:'room_15', x:1033, y:383, type:'stay',  frames:['mikachan-1.png','mikachan-2.png'],                       color:'#9988cc', size:58,  name:'Mikachan',           nameJP:'ミカちゃん',         desc:'Mikachan comes when you\'re alone, where something old is softly known. It waits behind what time won\'t keep, in corners where your memories sleep. A nightmare\'s fear, a deeper seam, it lingers just outside the dream. You may escape, you may outrun—but what it touched will stay undone.',                                                   descJP:'ミカちゃんは、ひとりのときにやってくる――どこか懐かしい気配の中で。時間に取り残されたものの裏側で、眠っていた記憶のそばに潜んでいる。悪夢さえも恐れる存在で、夢の外側に静かにとどまり続ける。逃げることはできても、一度触れた記憶はずっと残り続ける。' },
