...
/* ═══════════════════════════════════════════
  ...
  ═══════════════════════════════════════════ */
  const WANDERER_DEFS = [
    { index:0,  roomId:'room_01', x:642,  y:496, type:'stay',  frames:['ichi-1.png','ichi-2.png'],                               color:'#ff79d7', size:52,  name:'Ichi',              nameJP:'壱',              desc:'The first of three, as mean as can be, Ichi was planted beneath Karasuki. His words cut sharp and never miss, he tears apart what others dismiss. He picks and prods at all he sees, and never lets a moment ease. He may be cruel in all he\'ll say—but he is right in every way.',                                                            descJP:'三人のうちの最初、イチはカラスキーの木の下に植えられた。言葉は鋭く、見逃すことなく、隠れたものを引きずり出す。誰にでもきつく当たり、休まる時間を与えない。意地悪に聞こえても、その言葉はいつも正しい。' },
    { index:1,  roomId:'room_01', x:798,  y:418, type:'stay',  frames:['mr_happy-1.png','mr_happy-2.png'],                       color:'#ffd166', size:110, name:'Mister Happy',      nameJP:'ミスター・ハッピー', desc:'Mister Happy walks Karasuki, and claims to know it perfectly. He gathers what the world has lost, no matter where or what the cost. He smiles wide and leads them through, as if he knows just what to do. And that bright face is not a show—it\'s simply all he\'s come to know.',                                                             descJP:'ミスター・ハッピーはカラスキーを歩き、そのすべてを知っていると言い張る。失われたものをどこからでも連れてきて、ここに集めている。迷うことなく導くその姿は、すべてを理解しているかのようだ。そしてその顔の色は作られたものではなく、もともとの姿なのだ。' },
    { index:2,  roomId:'room_02', x:882,  y:263, type:'stay',  frames:['tom_katsu-1.png','tom_katsu-2.png'],                     color:'#ffaa5e', size:65,  name:'Tom Katsu',          nameJP:'トム・カツ',          desc:'Tom Katsu watched the bright things pop, where joy would rise and sudden stop. A fragile world that burst too fast, a happiness that couldn\'t last. Now one small light floats by his side, a quiet place for him to hide. A drifting fix for what he knew, a softer shade of something true.',                                                   descJP:'トム・カツは、弾けて消える楽しさを見続けてきた。すぐに終わってしまう幸せに、どこか寂しさを感じていた。今はひとつの風船がそばに浮かび、静かに寄り添っている。それは小さな救いであり、彼にとってのやさしい居場所になっている。' },
    { index:3,  roomId:'room_03', x:546,  y:308, type:'stay',  frames:['uhibon-1.png','uhibon-2.png'],                           color:'#a8edff', size:72,  name:'Uhibon',             nameJP:'ウヒボン',          desc:'No one knows where Uhibon began, not even him, not even a plan. He came from somewhere far outside, with something lost he cannot hide. He knows there was a time before, a self he cannot reach anymore. A hollow trace, a fading tone—what once was his is now unknown.',                                                                      descJP:'ウヒボンがどこから来たのか、誰も知らない。本人でさえも。カラスキーの外から来たことだけは、なんとなくわかっている。骨になる前の記憶があったはずだが、もう思い出せない。かつての自分は、今ではもう手の届かないものになっている。' },
    { index:4,  roomId:'room_04', x:888,  y:422, type:'stay',  frames:['jacki-1.png','jacki-2.png'],                             color:'#b2ffda', size:110, name:'Jacki',              nameJP:'ジャッキー',        desc:'From distant paths where Karasuki grows, Jacki walks where the lost wind blows. A mirror figure, or so they say, of someone known in a different way. He watches close but stays apart, with quiet eyes and guarded heart. Not quite at home, not passing through—just waiting there, and watching you.',                                         descJP:'ジャッキーは別のカラスキーから来た存在だと言われている。どこかミスター・ハッピーに似ているとも語られている。失われたものたちの中を歩きながら、静かに見守っている。ここに属するわけでもなく、ただそこに存在し続けている。' },
    { index:5,  roomId:'room_05', x:1054, y:354, type:'stay',  frames:['jamariko-1.png','jamariko-2.png'],                       color:'#fff176', size:70,  name:'Jamariko',           nameJP:'ジャマリコ',        desc:'Jamariko stands where you must see, exactly where you need to be. Step to the side or shift your view, it\'s always there in front of you. It blocks the path with gentle grace, a quiet smile upon its face. No matter when or where you try—it never moves, it won\'t pass by.',                                                               descJP:'ジャマリコは、必ず見たい場所に立っている。どこに動いても、視界の中心に入り込んでくる。やさしい顔をしているのに、決して道を譲らない。昼でも夜でも、ずっとそこに立ち続けている。' },
    { index:6,  roomId:'room_05', x:1029, y:502, type:'stay',  frames:['san-1.png','san-2.png'],                                 color:'#ffd08a', size:52,  name:'San',                nameJP:'参',                desc:'The last of three, as wild as can, San bit Karasuki before it began. A laughing crack before the start, a restless, tearing, reckless part. He never changed, not even one day, just stayed that strange and broken way. A burst of chaos, loud and bright—still laughing through the endless night.',                                            descJP:'三人のうちの最後で、とても狂っている。始まる前にカラスキーをかじり、そのままになってしまった。一度も変わることなく、その異質なままで存在している。ただ笑いながら、荒々しく動き続けている。' },
    { index:7,  roomId:'room_06', x:819,  y:268, type:'haunt', frames:['gorogane-1.png','gorogane-2.png'],                       color:'#a8fff8', size:120, name:'Gorogui',            nameJP:'ゴログイ',          desc:'Once they were people with hunger inside, now hunger\'s the only thing they can find. They move like echoes that don\'t feel right, pulled by something out of sight. Their bodies shift, but not their will—something deeper moves them still. If one draws near, don\'t trust the view—something worse is watching you.',                        descJP:'かつては人だったが、今は飢えだけが残っている。その動きはどこかおかしく、見えない何かに引かれている。自分の意思ではなく、もっと深いものに操られている。もし近づいてきたら、その姿を信じてはいけない。' },
    { index:8,  roomId:'room_06', x:522,  y:350, type:'haunt', frames:['sumiyo_horaguchi-1.png','sumiyo_horaguchi-2.png'],       color:'#90aaff', size:88,  name:'Sumiyo Horaguchi',  nameJP:'洞口すみよ',        desc:'If you see her, don\'t turn away—one glance lost and she won\'t delay. Look away once and she\'ll be near, just behind, just out of clear. If you don\'t look, she\'ll follow through, step by step, attaching to you. And once she\'s in, she won\'t let go—you\'ll lose yourself before you know.',                                           descJP:'もし見かけたら、決して目をそらしてはいけない。一瞬でも視線を外せば、すぐ後ろに現れる。見ていない限り、どこまでもついてくる。一度入り込まれると、気づかないうちに自分を失っていく。' },
    { index:9,  roomId:'room_07', x:815,  y:398, type:'stay',  frames:['amekuro-1.png','amekuro-2.png'],                         color:'#d49aff', size:52,  name:'Amekuro',            nameJP:'アメクロ',          desc:'Amekuro chatter from place to place, with endless talk and a sweet little face. They greet each voice that passes by, and never pause to question why. But show them sweets and they won\'t wait—it\'s gone at once, devoured by fate. They\'ll keep on talking, just the same, as if the world\'s one endless game.',                           descJP:'アメクロはどこでも話しかけてくる、おしゃべりな存在。誰にでも気軽に声をかけ、話し続ける。でもお菓子を見せると、一瞬で食べてしまう。それでも何も変わらず、ずっと話し続けている。' },
    { index:10, roomId:'room_07', x:456,  y:470, type:'stay',  frames:['snakuma-1.png','snakuma-2.png'],                         color:'#88ff88', size:150, name:'Snakuma',            nameJP:'スナクマ',          desc:'Snakuma wander, slow and wide, with gathered things they wear with pride. Lost little pieces, never the same, now rest upon their heavy frame. No one asks and no one sees, how things just change so quietly. They pass on by, and nothing stays—just altered shapes in silent ways.',                                                              descJP:'スナクマはゆっくり歩き、見つけたものを身につけている。失われたものたちが、当たり前のようにそこにある。誰も理由を聞かず、誰も気にしない。ただ形だけが変わり、静かに残されていく。' },
    { index:11, roomId:'room_08', x:979,  y:397, type:'stay',  frames:['robert-1.png','robert-2.png'],                           color:'#ffaa88', size:72,  name:'Robert',             nameJP:'ロバート',          desc:'Robert sees what others hide, beneath the mask they keep outside. Old and worn, he knows the game, and calls each lie by its true name. He helps or tricks—it\'s all the same, depending on his passing aim. If he should care, he might be kind… but most days, he just doesn\'t mind.',                                                        descJP:'ロバートは、他人の仮面の奥を見抜く。古く静かに、そのすべてを理解している。助けることも、だますこともあるが、それは気まぐれだ。気に入れば優しくなるが、ほとんどは気にしていない。' },
    { index:12, roomId:'room_08', x:1113, y:409, type:'stay',  frames:['jeffrey-1.png','jeffrey-2.png'],                         color:'#ffcc44', size:65,  name:'Jeffrey',            nameJP:'ジェフリー',        desc:'Jeffrey smiles with sharpened grin, and twists the truth just slightly thin. He says what\'s real—but bends the line, until it slips just out of time. Each word he speaks will shift the frame, until the truth feels off and strange. And when it breaks, he laughs it through—enjoying what it does to you.',                                 descJP:'ジェフリーは皮肉な笑みを浮かべる。真実を語るが、少しだけ歪めて伝える。その言葉は少しずつ現実をずらしていく。違和感が生まれるほど、それを楽しんでいる。' },
    { index:13, roomId:'room_08', x:1256, y:444, type:'stay',  frames:['johnny-1.png','johnny-2.png'],                           color:'#ff8844', size:70,  name:'Johnny',             nameJP:'ジョニー',          desc:'Johnny moves before you think, never stops to pause or blink. He cuts things short and runs ahead, leaving half of what was said. Stillness fades the moment through—he\'s already done with you. "Make it quick," he\'ll always say—then lose interest anyway.',                                                                               descJP:'ジョニーは考えるより先に動く。止まることも待つことも嫌いだ。途中で切り上げて、すぐ次へ進んでいく。「早くしろ」と言いながら、すぐに飽きてしまう。' },
    { index:14, roomId:'room_09', x:843,  y:413, type:'haunt', frames:['nulvane-1.png','nulvane-2.png'],                         color:'#c8aaff', size:160, name:'Nulvane',            nameJP:'ヌルヴェイン',      desc:'Nulvane drift where forms don\'t stay, between what\'s real and slipped away. They flicker through a half-made life, untouched by shape, untouched by strife. Not quite a self, not fully gone, they linger in a space withdrawn. A maybe-thing, a nearly-you—something that almost came true.',                                                descJP:'ヌルヴェインは、形を持たないまま漂っている。現実と未完成のあいだに存在している。誰かになりかけたまま、止まってしまった存在。完全でも消えてもいない、曖昧なまま残っている。' },
    { index:15, roomId:'room_10', x:1233, y:452, type:'stay',  frames:['ni-1.png','ni-2.png'],                                   color:'#e8ffaa', size:52,  name:'Ni',                 nameJP:'弐',                desc:'The second of three, as dull as can be, Ni is the last to leave the tree. He sits beneath what falls above, and never questions, never shoves. White marks gather, day by day, but he just lets it stay that way. No rush, no thought, no need to see—he simply sits, content to be.',                                                          descJP:'三人のうちの二番目で、とても鈍い。いつも最後まで木の下に残っている。上から落ちるものも、まったく気にしない。何も考えず、ただそこに座り続けている。' },
    { index:16, roomId:'room_11', x:935,  y:397, type:'stay',  frames:['columbus-1.png','columbus-2.png'],                       color:'#ff85a1', size:58,  name:'Columbus',           nameJP:'コロンバス',        desc:'Columbus runs the wrong way round, when something\'s tossed, he leaves the ground. He loves the game but breaks the rule, turning play to something new. A chase that leads to nowhere fast, a moment gone before it lasts. What should return is lost instead—a path that twists inside his head.',                                              descJP:'コロンバスはボールを投げると逆方向へ走る。遊びは好きだが、ルールは守らない。追いかけても戻ってこない、どこかへ行ってしまう。本来の流れとは違う方向へ進んでいく。' },
    { index:17, roomId:'room_12', x:700,  y:270, type:'stay',  frames:['october_moriyama-1.png','october_moriyama-2.png'],       color:'#ff79d7', size:78,  name:'October Moriyama',  nameJP:'オクトーバー・森山', desc:'October shrugs at what you fear, as if it\'s nothing worth a tear. She says she\'s fine, she\'s always fine, as if there\'s nothing out of line. But something stirs beneath that face, a quiet shift she can\'t erase. She stands her ground and plays it cool—while something bends beneath the rule.',                                      descJP:'オクトーバーは、どんなことにも動じない。すべてを軽く受け流しているように見える。怖くないと言い張るが、内側では何かが揺れている。冷静に見えても、その奥には不安が残っている。' },
    { index:18, roomId:'room_13', x:407,  y:387, type:'stay',  frames:['takachika_green-1.png','takachika_green-2.png'],         color:'#7fffd4', size:77,  name:'Takachika Green',   nameJP:'タカチカ・グリーン', desc:'Takachika wished for something more, and stepped beyond a hidden door. Though fear still walks beside his view, he follows paths others won\'t pursue. Each step he takes feels thin and new, like seeing things you\'re not meant to. He moves ahead, though unsure why—to face the things most pass by.',                                      descJP:'タカチカは「何か」を見たいと願い、見えない扉を開いた。怖さを抱えたまま、誰も進まない道を歩いていく。その一歩一歩は、不確かで揺らいでいる。それでも、誰も見ようとしないものに向き合おうとしている。' },
    { index:19, roomId:'room_13', x:609,  y:642, type:'stay',  frames:['pugoo-1.png','pugoo-2.png'],                             color:'#ffcc66', size:55,  name:'Pugoo',              nameJP:'パグー',            desc:'Pugoo walks a step behind, with steady eyes that always find. He never strays, he never slips, he stays through cracks and quiet drifts. Where darkness leans, he lingers near, a silent shape that steadies fear. Not loud, not fast—but always there, a quiet guard that seems to care.',                                                     descJP:'パグーはいつも少し後ろを歩いている。静かな目で、すべてを見つめている。離れることなく、ずっとそばにいる存在。目立たないけれど、確かに守ってくれている。' },
    { index:20, roomId:'room_14', x:930,  y:318, type:'haunt', frames:['ena_yamakage-1.png','ena_yamakage-2.png'],               color:'#ffb3d9', size:81,  name:'Ena Yamakage',       nameJP:'山影えな',          desc:'Ena comes when night feels thin, and sees the things you keep within. She points them out with laughing eyes, at all the parts you try to hide. Her voice will echo, sharp and clear, repeating what you fear to hear. And once it starts, it doesn\'t end—the sound will stay, it won\'t pretend.',                                            descJP:'えなは、不気味な夜に現れる。目が合えば、隠しているものまで見抜かれてしまう。それを指差して笑い、何度も繰り返す。その声は消えず、ずっと残り続ける。' },
    { index:21, roomId:'room_15', x:850,  y:480, type:'haunt', frames:['tsukigase_jubei-1.png','tsukigase_jubei-2.png'],         color:'#ffcc66', size:100, name:'Jubei Tsukigase',    nameJP:'月ヶ瀬 寿兵衛',     desc:'Jubei worked through night and day, and let his whole life slip away. No time to stop, no time to see, what waited where he used to be. The years moved on without a sound, and took what once had kept him bound. Now something calls from far ahead—a different path, a different thread.',                                                    descJP:'寿兵衛は働き続け、止まることを知らなかった。振り返ることもなく、すべてを過ぎ去らせてしまった。気づけば時間は静かにすべてを奪っていた。今は別の何かに呼ばれ、新しい道へと向かっている。' },
    { index:22, roomId:'room_02', x:601,  y:410, type:'stay',  frames:['denoying-1.png','denoying-2.png'],                       color:'#a8edff', size:70,  name:'Denoying',           nameJP:'ディノイング',       desc:'Denoying ask and never stop, each question stacking on the top. They pull you in with every "why," until the minutes pass you by. Each answer leads to something more, a deeper path than just before. What once was simple twists and bends—until it never truly ends.',                                                                        descJP:'ディノイングは「どうして？」と問い続ける。一つ答えるたびに、さらに深く引き込まれる。時間はどんどん過ぎていき、終わりが見えなくなる。単純だったことも、どこまでも複雑になっていく。' },
    { index:23, roomId:'room_12', x:449,  y:569, type:'stay',  frames:['poopika-1.png','poopika-2.png'],                         color:'#ffcc66', size:58,  name:'Poopika',            nameJP:'プピカ',            desc:'Poopika react to all they see, with endless wonder instantly. Even nothing feels alive, when something strange begins to thrive. A flicker caught, a shining glare—and suddenly they\'re trapped in stare. Lost in their glow, they drift away, forgetting all that came that day.',                                                            descJP:'プピカは、見えるものすべてに反応する。何もないことさえ、不思議に感じてしまう。光や反射に目を奪われ、その場にとどまる。やがて夢中になり、周りのことを忘れてしまう。' },
    { index:24, roomId:'room_11', x:1170, y:381, type:'stay',  frames:['whistler-1.png','whistler-2.png'],                       color:'#c8d8ff', size:58,  name:'Whistler',           nameJP:'ウィスラー',         desc:'Whistler works from day to night, and slips through shadows out of sight. It gathers all it finds and sees, and keeps them close with quiet ease. It hums a tune, a drifting call, as moonlight leans on every wall. If whistles rise within the night, something small is gone by light.',                                                    descJP:'ウィスラーは朝から夜まで働き、影の中を動き回る。見つけたものを少しずつ集めて、自分のものにしていく。夜になると、どこからともなく口笛が聞こえてくる。その音が聞こえたなら、小さな何かはなくなっている。' },
    { index:25, roomId:'room_10', x:993,  y:421, type:'stay',  frames:['woozlebock-1.png','woozlebock-2.png'],                   color:'#b8d4c8', size:58,  name:'Woozlebock',         nameJP:'ウーズルボック',     desc:'Woozlebock walks where shadows stay, turning wrong things the gentler way. It finds what\'s lost, what\'s torn apart, and stitches warmth into the heart. It hums where quiet darkness clings, and softens sharp and broken things. If you meet one, don\'t feel alarm—your heavy thoughts will turn to calm.',                                  descJP:'ウーズルボックは影の中を歩き、ゆがんだものをやさしく変えていく。失われたものや壊れたものに、ぬくもりをそっと与えていく。静かな闇に寄り添い、尖ったものを丸くしていく。出会えば、不安はほどけて、心が軽くなっていく。' },
    { index:26, roomId:'room_04', x:516,  y:444, type:'stay',  frames:['tanoshiika-1.png','tanoshiika-2.png'],                   color:'#ffe0a0', size:58,  name:'Tanoshiika',         nameJP:'タノシイカ',         desc:'Tanoshiika drifts where laughter grows, and follows light wherever it flows. It dances near each joyful sound, and stays where gentle smiles are found. It greets all hearts, both near and far, and loves you simply as you are. But should unease begin to wake, it slips away like morning break.',                                          descJP:'タノシイカは笑いのある場所に寄り、やさしい空気をたどる。楽しい声のそばで過ごし、穏やかな笑顔の中にいる。どんな存在にも寄り添い、そのままを受け入れる。でも不安がよぎると、朝のようにすっと消えてしまう。' },
    { index:27, roomId:'room_15', x:1200, y:400, type:'haunt', frames:['mikachan-1.png','mikachan-2.png'],                       color:'#9988cc', size:90,  name:'Mikachan',           nameJP:'ミカちゃん',         desc:'Mikachan comes when you\'re alone, where something old is softly known. It waits behind what time won\'t keep, in corners where your memories sleep. A nightmare\'s fear, a deeper seam, it lingers just outside the dream. You may escape, you may outrun—but what it touched will stay undone.',                                             descJP:'ミカちゃんは、ひとりのときにやってくる。懐かしい記憶の裏側で、静かに潜んでいる。夢の外にとどまり続ける、悪夢すら恐れる存在。逃げても、一度触れた記憶は消えずに残る。' },
    { index:28, roomId:'room_01', x:1048, y:477, type:'stay',  frames:['kara-ageha-1.png','kara-ageha-2.png'],                   color:'#ffccaa', size:58,  name:'Kara Ageha',         nameJP:'カラ・アゲハ',       desc:'Kara Ageha walks from what once was, carrying quiet, unseen loss. She gave and gave and kept no part, until it faded from her heart. Now small things fill the space she keeps, in tiny finds and gentle heaps. She builds her joy from what she sees, in borrowed light and quiet ease.',                                                      descJP:'カラアゲハは、かつての世界の名残を抱えて歩いている。与え続ける中で、大切なものを失ってしまった。今は小さな持ち物の中に、少しずつ喜びを集めている。拾い集めたもので、静かに心を満たしている。' },
    { index:29, roomId:'room_02', x:665,  y:651, type:'stay',  frames:['jinguru-kan-1.png','jinguru-kan-2.png'],                 color:'#aaccff', size:58,  name:'Jinguru Kan',        nameJP:'ジングル・カン',     desc:'Jinguru Kan stays close to sound, where gentle echoes gather round. She lost what once was always near, one by one, then none to hear. A bell now rings where she may roam, a steady chime to guide her home. If she should fade or slip from sight, its lonely song will lead the light.',                                                   descJP:'ジングルカンは音のそばで静かに過ごしている。大切な存在は、一つずつ消えていった。今は鈴の音が、帰る場所を示してくれる。もし見えなくなっても、その音が導いてくれる。' },
  ];
