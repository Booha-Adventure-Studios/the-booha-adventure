    ...
    s.textContent = `
      ...
      #sb-jp-word {
        ...
        text-shadow:
          ...
          0 0 calc(var(--blitz-word-glow, 64px) * 1.5) var(--blitz-word-glow-color, var(--sb-glow));
      ...
      #sb-hira {
        ...
        line-height: 1.6;
        text-shadow: 0 0 calc(var(--blitz-word-glow, 64px) * .28) var(--blitz-word-glow-color, var(--sb-glow));
  ...
  function buildOverlay() {
    ...
    el.innerHTML = `
      ...
      <div id="sb-wrong-popup" class="blitz-wrong-feedback">
        ...
        <button id="sb-wrong-close" type="button">つぎへ / CONTINUE</button>
      </div>
