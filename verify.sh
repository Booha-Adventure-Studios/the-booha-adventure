...
echo "[1/21] Content JSON validity"
...
echo "[2/21] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/21] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/21] Cache bump vs. changed files"
...
echo "[6/21] calendar.js loads before core stack"
order_bad=0
...
echo "[7/21] juku.json content checks"
...
echo "[8/21] Utsuroba episode audit"
...
echo "[9/21] Utsuroba resolver audit"
...
echo "[10/21] Utsuroba memory progress audit"
...
echo "[11/21] Utsuroba journal audit"
...
echo "[13/21] Muenba reading-lock audit"
...
echo "[15/21] Muenba celebration audit"
...
echo "[16/21] Muenba memory progress audit"
...
echo "[17/21] Muenba navigation audit"
...
echo "[20/21] Feed Booha level audit"
...
echo "[21/21] Feed Booha playability simulation"
