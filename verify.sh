...
echo "[1/15] Content JSON validity"
...
echo "[2/15] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/15] Cache version sync (pages/assets/decks)"
...
echo "[4/15] Cache bump vs. changed files"
...
echo "[6/15] calendar.js loads before core stack"
order_bad=0
...
echo "[7/15] juku.json content checks"
...
echo "[8/15] Utsuroba episode audit"
...
echo "[9/15] Utsuroba memory progress audit"
...
echo "[10/15] Utsuroba journal audit"
...
echo "[12/15] Muenba memory progress audit"
...
echo "[13/15] Muenba navigation audit"
...
echo "[14/15] Feed Booha level audit"
...
echo "[15/15] Feed Booha playability simulation"
