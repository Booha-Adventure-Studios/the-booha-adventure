...
echo "[1/29] Content JSON validity"
...
echo "[2/29] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/29] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/29] Cache bump vs. changed files"
...
echo "[6/29] calendar.js loads before core stack"
order_bad=0
...
echo "[7/29] juku.json content checks"
...
echo "[8/29] Utsuroba episode audit"
...
echo "[9/29] Utsuroba resolver audit"
...
echo "[10/29] Utsuroba memory progress audit"
...
echo "[11/29] Utsuroba journal audit"
...
echo "[13/29] Muenba reading-lock audit"
...
echo "[15/29] Muenba celebration audit"
...
echo "[17/29] Muenba return-threat audit"
...
echo "[18/29] Muenba Pass 17 regression audit"
...
echo "[19/29] Muenba 19H journey audit"
...
echo "[20/29] Muenba 19I entry audit"
...
echo "[21/29] Muenba memory progress audit"
...
echo "[22/29] Muenba navigation audit"
...
echo "[25/29] Feed Booha level audit"
...
echo "[26/29] Feed Booha playability simulation"
...
echo "[27/29] UtsuCard 20A celebration audit"
...
echo "[28/29] Karasuki 20B Wanderer celebration audit"
...
echo "[29/29] Karasuki 20C return celebration audit"
