...
echo "[1/10] Content JSON validity"
...
echo "[2/10] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/10] Cache version sync (pages/assets/decks)"
...
echo "[4/10] Cache bump vs. changed files"
...
echo "[6/10] calendar.js loads before core stack"
order_bad=0
...
echo "[7/10] juku.json content checks"
