...
echo "[1/16] Content JSON validity"
...
echo "[2/16] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[4/16] Cache bump vs. changed files"
...
echo "[6/16] calendar.js loads before core stack"
order_bad=0
...
echo "[7/16] juku.json content checks"
...
echo "[8/16] Utsuroba episode audit"
...
echo "[9/16] Utsuroba resolver audit"
...
echo "[10/16] Utsuroba memory progress audit"
...
echo "[11/16] Utsuroba journal audit"
...
echo "[13/16] Muenba memory progress audit"
...
echo "[14/16] Muenba navigation audit"
...
echo "[15/16] Feed Booha level audit"
...
echo "[16/16] Feed Booha playability simulation"
