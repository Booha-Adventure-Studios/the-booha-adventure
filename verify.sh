...
echo "[1/19] Content JSON validity"
...
echo "[2/19] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/19] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/19] Cache bump vs. changed files"
...
echo "[6/19] calendar.js loads before core stack"
order_bad=0
...
echo "[7/19] juku.json content checks"
...
echo "[8/19] Utsuroba episode audit"
...
echo "[9/19] Utsuroba resolver audit"
...
echo "[10/19] Utsuroba memory progress audit"
...
echo "[11/19] Utsuroba journal audit"
...
echo "[13/19] Muenba reading-lock audit"
...
echo "[14/19] Muenba memory progress audit"
...
echo "[15/19] Muenba navigation audit"
...
echo "[18/19] Feed Booha level audit"
...
echo "[19/19] Feed Booha playability simulation"
