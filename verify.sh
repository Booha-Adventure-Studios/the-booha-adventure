...
echo "[1/11] Content JSON validity"
...
echo "[2/11] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/11] Cache version sync (pages/assets/decks)"
...
echo "[4/11] Cache bump vs. changed files"
...
echo "[6/11] calendar.js loads before core stack"
order_bad=0
...
echo "[7/11] juku.json content checks"
