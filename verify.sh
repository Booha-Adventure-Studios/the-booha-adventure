...
echo "[1/24] Content JSON validity"
...
echo "[2/24] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/24] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/24] Cache bump vs. changed files"
...
echo "[6/24] calendar.js loads before core stack"
order_bad=0
...
echo "[7/24] juku.json content checks"
...
echo "[8/24] Utsuroba episode audit"
...
echo "[9/24] Utsuroba resolver audit"
...
echo "[10/24] Utsuroba memory progress audit"
...
echo "[11/24] Utsuroba journal audit"
...
echo "[13/24] Muenba reading-lock audit"
...
echo "[15/24] Muenba celebration audit"
...
echo "[17/24] Muenba return-threat audit"
...
echo "[18/24] Muenba Pass 17 regression audit"
...
echo "[19/24] Muenba memory progress audit"
...
echo "[20/24] Muenba navigation audit"
...
echo "[23/24] Feed Booha level audit"
...
echo "[24/24] Feed Booha playability simulation"
