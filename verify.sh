...
echo "[1/28] Content JSON validity"
...
echo "[2/28] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/28] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/28] Cache bump vs. changed files"
...
echo "[6/28] calendar.js loads before core stack"
order_bad=0
...
echo "[7/28] juku.json content checks"
...
echo "[8/28] Utsuroba episode audit"
...
echo "[9/28] Utsuroba resolver audit"
...
echo "[10/28] Utsuroba memory progress audit"
...
echo "[11/28] Utsuroba journal audit"
...
echo "[13/28] Muenba reading-lock audit"
...
echo "[15/28] Muenba celebration audit"
...
echo "[17/28] Muenba return-threat audit"
...
echo "[18/28] Muenba Pass 17 regression audit"
...
echo "[19/28] Muenba 19H journey audit"
...
echo "[20/28] Muenba 19I entry audit"
...
echo "[21/28] Muenba memory progress audit"
...
echo "[22/28] Muenba navigation audit"
...
echo "[25/28] Feed Booha level audit"
...
echo "[26/28] Feed Booha playability simulation"
...
echo "[27/28] UtsuCard 20A celebration audit"
...
echo "[28/28] Karasuki 20B Wanderer celebration audit"
