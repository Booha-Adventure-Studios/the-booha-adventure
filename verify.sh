...
echo "[1/14] Content JSON validity"
...
echo "[2/14] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/14] Cache version sync (pages/assets/decks)"
...
echo "[4/14] Cache bump vs. changed files"
...
echo "[6/14] calendar.js loads before core stack"
order_bad=0
...
echo "[7/14] juku.json content checks"
...
echo "[8/14] Utsuroba episode audit"
...
echo "[9/14] Utsuroba memory progress audit"
...
echo "[10/14] Utsuroba journal audit"
...
echo "[12/14] Muenba memory progress audit"
...
echo "[13/14] Feed Booha level audit"
...
echo "[14/14] Feed Booha playability simulation"
