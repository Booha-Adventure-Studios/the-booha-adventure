...
echo "[1/25] Content JSON validity"
...
echo "[2/25] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/25] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/25] Cache bump vs. changed files"
...
echo "[6/25] calendar.js loads before core stack"
order_bad=0
...
echo "[7/25] juku.json content checks"
...
echo "[8/25] Utsuroba episode audit"
...
echo "[9/25] Utsuroba resolver audit"
...
echo "[10/25] Utsuroba memory progress audit"
...
echo "[11/25] Utsuroba journal audit"
...
echo "[13/25] Muenba reading-lock audit"
...
echo "[15/25] Muenba celebration audit"
...
echo "[17/25] Muenba return-threat audit"
...
echo "[18/25] Muenba Pass 17 regression audit"
...
echo "[19/25] Muenba 19H journey audit"
...
echo "[20/25] Muenba memory progress audit"
...
echo "[21/25] Muenba navigation audit"
...
echo "[24/25] Feed Booha level audit"
...
echo "[25/25] Feed Booha playability simulation"
