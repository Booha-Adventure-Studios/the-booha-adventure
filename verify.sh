...
echo "[1/18] Content JSON validity"
...
echo "[2/18] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/18] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/18] Cache bump vs. changed files"
...
echo "[6/18] calendar.js loads before core stack"
order_bad=0
...
echo "[7/18] juku.json content checks"
...
echo "[8/18] Utsuroba episode audit"
...
echo "[9/18] Utsuroba resolver audit"
...
echo "[10/18] Utsuroba memory progress audit"
...
echo "[11/18] Utsuroba journal audit"
...
echo "[13/18] Muenba memory progress audit"
...
echo "[14/18] Muenba navigation audit"
...
echo "[17/18] Feed Booha level audit"
...
echo "[18/18] Feed Booha playability simulation"
