...
echo "[1/17] Content JSON validity"
...
echo "[2/17] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/17] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/17] Cache bump vs. changed files"
...
echo "[6/17] calendar.js loads before core stack"
order_bad=0
...
echo "[7/17] juku.json content checks"
...
echo "[8/17] Utsuroba episode audit"
...
echo "[9/17] Utsuroba resolver audit"
...
echo "[10/17] Utsuroba memory progress audit"
...
echo "[11/17] Utsuroba journal audit"
...
echo "[13/17] Muenba memory progress audit"
...
echo "[14/17] Muenba navigation audit"
...
echo "[16/17] Feed Booha level audit"
...
echo "[17/17] Feed Booha playability simulation"
