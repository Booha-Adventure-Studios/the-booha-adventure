...
echo "[1/32] Content JSON validity"
...
echo "[2/32] sw.js CORE_FILES exist on disk (addAll is all-or-nothing)"
sw_bad=0; sw_ok=0
...
echo "[3/32] Independent cache version validation"
cache_bad=0
cache_summary=""
...
echo "[4/32] Cache bump vs. changed files"
...
echo "[6/32] calendar.js loads before core stack"
order_bad=0
...
echo "[7/32] juku.json content checks"
...
echo "[8/32] Utsuroba episode audit"
...
echo "[9/32] Utsuroba resolver audit"
...
echo "[10/32] Utsuroba memory progress audit"
...
echo "[11/32] Utsuroba journal audit"
...
echo "[13/32] Muenba reading-lock audit"
...
echo "[15/32] Muenba celebration audit"
...
echo "[17/32] Muenba return-threat audit"
...
echo "[18/32] Muenba Pass 17 regression audit"
...
echo "[19/32] Muenba 19H journey audit"
...
echo "[20/32] Muenba 19I entry audit"
...
echo "[21/32] Muenba memory progress audit"
...
echo "[22/32] Muenba navigation audit"
...
echo "[25/32] Feed Booha level audit"
...
echo "[26/32] Feed Booha playability simulation"
...
echo "[27/32] UtsuCard 20A celebration audit"
...
echo "[28/32] Karasuki 20B Wanderer celebration audit"
...
echo "[29/32] Karasuki 20C return celebration audit"
...
echo "[30/32] Karasuki 20D Nuppi furigana audit"
...
echo "[31/32] Karasuki 20E Observer audit"
...
echo "[32/32] Karasuki 20F celebration audio audit"
