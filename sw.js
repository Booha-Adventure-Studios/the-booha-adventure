...
const CURRENT_CACHES = {
  ...
  // Family Room Pass 4: proximity-scaled alert sprites and Lies-tier false
  // alerts also travel through the network-first JavaScript path.
...
const CORE_ASSETS = [
  ...
  `${BASE}/assets/family-room/overlays/bowl.webp`,
  `${BASE}/assets/family-room/overlays/cup.webp`,
  `${BASE}/assets/family-room/overlays/eyes.webp`,
  `${BASE}/assets/family-room/overlays/shadow.webp`,
  `${BASE}/assets/family-room/overlays/talisman.webp`,
  `${BASE}/assets/family-room/overlays/lantern.webp`,
  `${BASE}/assets/family-room/overlays/futon.webp`,
  ...
  `${BASE}/assets/family-room/pataskala/pataskala_far.webp`,
  `${BASE}/assets/family-room/pataskala/pataskala_enter.webp`,
  `${BASE}/assets/family-room/pataskala/pataskala_approach.webp`,
  `${BASE}/assets/family-room/pataskala/pataskala_near.webp`,
  `${BASE}/assets/family-room/pataskala/pataskala_catch.webp`,
  `${BASE}/js/utsu-sfx.js`,
