...
assert(/pages:\s+'booha-pages-2026-399'/.test(serviceWorker), 'page cache must be bumped for the Grimmerglen profile-link update');
...
assert(/assets:\s+'booha-assets-2026-483'/.test(serviceWorker), 'asset cache must be bumped for the Grimmerglen profile-link update');
