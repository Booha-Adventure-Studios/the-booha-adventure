...
assert(/pages:\s+'booha-pages-2026-391'/.test(serviceWorker), 'page cache must be bumped for the Grimmerglen Pass 2 profile update');
...
assert(/assets:\s+'booha-assets-2026-475'/.test(serviceWorker), 'asset cache must be bumped for the Grimmerglen memory assistance update');
