...
assert(/pages:\s+'booha-pages-2026-389'/.test(serviceWorker), 'page cache must be bumped for the Grimmerglen Pass 6 update');
...
assert(/assets:\s+'booha-assets-2026-472'/.test(serviceWorker), 'asset cache must be bumped for the Grimmerglen memory assistance update');
