...
assert(/pages:\s+'booha-pages-2026-382'/.test(serviceWorker), 'page cache must be bumped for the entry pass');
...
assert(/assets:\s+'booha-assets-2026-463'/.test(serviceWorker), 'asset cache must be bumped for the Marietta help-gating pass');
