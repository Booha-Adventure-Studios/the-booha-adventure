...
assert(/pages:\s+'booha-pages-2026-388'/.test(serviceWorker), 'page cache must be bumped for the Grimmerglen Pass 4 update');
...
assert(/assets:\s+'booha-assets-2026-471'/.test(serviceWorker), 'asset cache must be bumped for the Grimmerglen Pass 2 schema');
