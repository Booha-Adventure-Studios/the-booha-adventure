...
assert(/pages:\s+'booha-pages-2026-414'/.test(serviceWorker), 'page cache must be bumped for the performance pass');
...
assert(/assets:\s+'booha-assets-2026-567'/.test(serviceWorker), 'asset cache must be bumped for the Grimmerglen eager-precache perf fix');
