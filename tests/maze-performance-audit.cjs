...
assert(sw.includes('booha-pages-2026-403'), 'Muenba Pass C profile markup must bump the page cache');
assert(sw.includes('booha-assets-2026-494'), 'Muenba canonical target release must bump the asset cache');
