...
assert(sw.includes('booha-pages-2026-420'), 'performance-pass markup must bump the page cache');
assert(sw.includes('booha-assets-2026-570'), 'Muenba canonical target release must bump the asset cache');
