...
assert(sw.includes('booha-pages-2026-384'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-465'), 'Grimmerglen quest visibility must bump the asset cache');
