...
assert(sw.includes('booha-pages-2026-381'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-442'), 'weekly sync persistence must bump the asset cache');
