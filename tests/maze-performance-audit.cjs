...
assert(sw.includes('booha-pages-2026-385'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-468'), 'Grimmerglen Content Pass 2 must bump the asset cache');
