...
assert(sw.includes('booha-pages-2026-391'), 'Grimmerglen Pass 2 profile markup must bump the page cache');
assert(sw.includes('booha-assets-2026-475'), 'Grimmerglen memory assistance must bump the asset cache');
