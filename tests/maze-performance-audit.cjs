...
assert(sw.includes('booha-pages-2026-380'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-440'), 'Maze WebP migration must bump the asset cache');
