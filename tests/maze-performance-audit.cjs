...
assert(sw.includes('booha-pages-2026-404'), 'Muenba Pass C profile markup must bump the page cache');
assert(sw.includes('booha-assets-2026-503'), 'Muenba canonical target release must bump the asset cache');
