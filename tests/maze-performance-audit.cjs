...
assert(sw.includes('booha-pages-2026-399'), 'Grimmerglen profile-link markup must bump the page cache');
assert(sw.includes('booha-assets-2026-483'), 'Grimmerglen profile-link release must bump the asset cache');
