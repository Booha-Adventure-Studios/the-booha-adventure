...
assert(sw.includes('booha-pages-2026-370'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-381'), 'Maze WebP migration must bump the asset cache');
