...
assert(sw.includes('booha-pages-2026-397'), 'Grimmerglen Pass 2 profile markup must bump the page cache');
assert(sw.includes('booha-assets-2026-481'), 'Grimmerglen memory assistance must bump the asset cache');
