...
assert(sw.includes('booha-pages-2026-402'), 'Muenba Pass A3 profile markup must bump the page cache');
assert(sw.includes('booha-assets-2026-484'), 'Muenba Pass B popup-shell release must bump the asset cache');
