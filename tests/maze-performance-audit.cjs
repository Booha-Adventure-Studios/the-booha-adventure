...
assert(sw.includes('booha-pages-2026-383'), 'Maze HTML migration must bump the page cache');
assert(sw.includes('booha-assets-2026-463'), 'Marietta help gating must bump the asset cache');
