...
assert(sw.includes('booha-pages-2026-411'), 'performance-pass markup must bump the page cache');
assert(sw.includes('booha-assets-2026-545'), 'Muenba canonical target release must bump the asset cache');
