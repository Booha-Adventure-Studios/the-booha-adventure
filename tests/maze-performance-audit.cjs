...
assert(sw.includes('booha-pages-2026-409'), 'performance-pass markup must bump the page cache');
assert(sw.includes('booha-assets-2026-514'), 'Muenba canonical target release must bump the asset cache');
