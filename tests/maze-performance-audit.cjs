...
assert(sw.includes('booha-pages-2026-407'), 'performance-pass markup must bump the page cache');
assert(sw.includes('booha-assets-2026-507'), 'Muenba canonical target release must bump the asset cache');
