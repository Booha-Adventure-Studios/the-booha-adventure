...
for (const [name, source] of [['Utsuroba', utsuroba], ['Grimmerglen', grimmerglen], ['Karasuki', karasuki]]) {
...
assert(sw.includes('booha-assets-2026-499'), 'Pass 5 changes must bump the asset cache');
