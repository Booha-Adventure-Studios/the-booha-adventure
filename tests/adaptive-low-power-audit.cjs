...
assert(utsuroba.includes('function targetCanvasDpr()')
  && utsuroba.includes("if (perfTier === 'low') return 1;"),
...
assert(sw.includes('booha-assets-2026-521'), 'Pass 5 changes must bump the asset cache');
