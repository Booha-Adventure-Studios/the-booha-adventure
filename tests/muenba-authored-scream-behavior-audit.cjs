...
// Pass 28B: authored scream playback and danger-state behavior.
...
console.log('Muenba 28B authored-scream behavior audit passed: staggered samples, decay, crossfade, rhythm silence, and dance profile lock are wired.');
