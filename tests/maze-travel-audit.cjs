...
assert(sw.includes('booha-pages-2026-426'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-572'), 'service-worker asset cache must include the current Muenba canonical target bump');
