...
assert(sw.includes('booha-pages-2026-408'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-508'), 'service-worker asset cache must include the current Muenba canonical target bump');
