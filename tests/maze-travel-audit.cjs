...
assert(sw.includes('booha-pages-2026-404'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-502'), 'service-worker asset cache must include the current Muenba canonical target bump');
