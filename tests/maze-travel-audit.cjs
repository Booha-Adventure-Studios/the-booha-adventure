...
assert(sw.includes('booha-pages-2026-415'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-567'), 'service-worker asset cache must include the current Muenba canonical target bump');
