...
assert(sw.includes('booha-pages-2026-369'), 'service-worker page cache must include the 23C page bump');
assert(sw.includes('booha-assets-2026-380'), 'service-worker asset cache must include the 23C cleanup bump');
