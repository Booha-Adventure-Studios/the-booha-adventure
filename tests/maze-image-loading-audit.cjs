...
assert(sw.includes('booha-pages-2026-397'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-481'), 'service-worker asset cache must include the current Grimmerglen memory assistance bump');
