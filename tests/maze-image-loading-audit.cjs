...
assert(sw.includes('booha-pages-2026-380'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-440'), 'service-worker asset cache must include the current asset bump');
