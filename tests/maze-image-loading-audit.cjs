...
assert(sw.includes('booha-pages-2026-371'), 'service-worker page cache must include the 23E page bump');
assert(sw.includes('booha-assets-2026-382'), 'service-worker asset cache must include the 23E cleanup bump');
