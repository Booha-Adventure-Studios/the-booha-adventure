...
assert(sw.includes('booha-pages-2026-370'), 'service-worker page cache must include the 23D page bump');
assert(sw.includes('booha-assets-2026-381'), 'service-worker asset cache must include the 23D cleanup bump');
