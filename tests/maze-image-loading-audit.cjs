...
assert(sw.includes('booha-pages-2026-401'), 'service-worker page cache must include the current page bump');
assert(sw.includes('booha-assets-2026-483'), 'service-worker asset cache must include the current Grimmerglen profile-link bump');
