...
assert(sw.includes('booha-pages-2026-368'), 'service-worker page cache must include the 23B page bump');
assert(sw.includes('booha-assets-2026-379'), 'service-worker asset cache must include the 23B cleanup bump');
