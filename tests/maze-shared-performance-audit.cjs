...
assert(sw.includes('booha-pages-2026-423'), 'Maze HTML changes must bump the page cache');
assert(sw.includes('booha-assets-2026-572'), 'Maze/shared-runtime changes must bump the asset cache');
