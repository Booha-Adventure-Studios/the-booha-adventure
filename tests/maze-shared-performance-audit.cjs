...
assert(sw.includes('booha-pages-2026-416'), 'Maze HTML changes must bump the page cache');
assert(sw.includes('booha-assets-2026-569'), 'Maze/shared-runtime changes must bump the asset cache');
