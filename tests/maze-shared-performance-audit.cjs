...
assert(sw.includes('booha-pages-2026-411'), 'Maze HTML changes must bump the page cache');
assert(sw.includes('booha-assets-2026-530'), 'Maze/shared-runtime changes must bump the asset cache');
